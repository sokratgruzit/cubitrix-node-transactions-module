...
router.post(
  "/update_options", 
  transactions_controller.update_options
);
...
router.post(
  "/coinbase_webhooks", 
  transactions_controller.coinbase_webhooks
);
...
router.post(
  "/make_transfer", 
  transactions_controller.make_transfer
);
...
router.post(
  "/direct_deposit", 
  transactions_controller.direct_deposit
);
...
router.post(
  "/exchange", 
  transactions_controller.exchange
);

router.post(
  "/make_withdrawal", 
  transactions_controller.make_withdrawal
);

router.post(
  "/stake_currency", 
  transactions_controller.stakeCurrency
);
...
router.post(
  "/give_rewards", 
  transactions_controller.give_rewards
);
...
router.post(
  "/cancel_exchange", 
  transactions_controller.cancel_exchange
);
